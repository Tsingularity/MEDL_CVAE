...
tf.app.flags.DEFINE_integer('max_epoch',400,'max epoch to train')
tf.app.flags.DEFINE_float('weight_decay',0.00001,'weight_decay')
tf.app.flags.DEFINE_float('save_epoch',2.0,'epochs to save model')

tf.app.flags.DEFINE_string('checkpoint_path', './model/resnet_model-11448','The path to a checkpoint from which to fine-tune.')
...
def main(_):
	...
	hg = resnet.resnet(is_training=False)
