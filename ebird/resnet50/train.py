...
tf.app.flags.DEFINE_integer('batch_size',32,'number of pictures in one batch')
...
#fine-tune flags
tf.app.flags.DEFINE_string('checkpoint_path', './model_warmup/resnet_model-795','The path to a checkpoint from which to fine-tune.')
