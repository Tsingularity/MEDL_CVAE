...
tf.app.flags.DEFINE_integer('batch_size',283*6*3,'number of pictures in one batch')
tf.app.flags.DEFINE_integer('z_dim',100,'z dimention')
tf.app.flags.DEFINE_string('checkpoint_path', './model/fc_model-37130','The path to a checkpoint from which to fine-tune.')
