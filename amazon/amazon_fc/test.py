...
tf.app.flags.DEFINE_string('checkpoint_path', './model/fc_model-11092','The path to a checkpoint from which to fine-tune.')
...
def main(_):
	...
	def test_step():
		...
		tempstr = "log_likelihood {:g}".format(loglike)
		print(tempstr)
